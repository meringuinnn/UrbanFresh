...
export class ReactNativeTracing {
    ...
    addGlobalEventProcessor, getCurrentHub) {
        ...
        tracingOrigins, 
        // @ts-ignore TODO
        shouldCreateSpanForRequest, tracePropagationTargets, routingInstrumentation, enableAppStartTracking, enableNativeFramesTracking, enableStallTracking, } = this.options;
